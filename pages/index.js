...
const dataPostagens = [
  { id: 0, label: "Manga", price: "2,99", beforePrice: "3,99", img: "/files/05.jpg", star: [{ state: 1, }, { state: 1 }, { state: 1 }, { state: 1 }, { state: 0 }] },
  { id: 1, label: "Abobrinha", price: "8,99", beforePrice: "12,27", img: "/files/04.jpg", star: [{ state: 1 }, { state: 1 }, { state: 1 }, { state: 1 }, { state: 0 }] },
  { id: 2, label: "Banana", price: "6,49", beforePrice: "7,25", img: "/files/01.jpg", star: [{ state: 1 }, { state: 1 }, { state: 1 }, { state: 1 }, { state: 0 }] },
  { id: 3, label: "Morango", price: "4,99", beforePrice: "6,99", img: "/files/07.jpg", star: [{ state: 1 }, { state: 1 }, { state: 1 }, { state: 1 }, { state: 1 }] },
  { id: 4, label: "Chuchu", price: "5,99", beforePrice: "7,99", img: "/files/10.jpg", star: [{ state: 1 }, { state: 1 }, { state: 1 }, { state: 1 }, { state: 0 }] }
]
      ...
      <Container>
        ...
        <Header>
          <FlexAlign as={FlexJustifyContent} justifyContent="space-between" style={{ height: 50 }}>
            ...
            <HeaderInput as={Flex}>
              ...
              <Flex>
                <div>
                  <Input style={{ width: 262 }} type="text" placeholder="Search Products, categories ..." />
                </div>
                <FlexAlign>
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
            ...
            <Flex as={FlexJustifyContent} justifyContent="space-between" style={{ width: 88 }}>
              ...
              <div style={{cursor: "pointer"}}>
                ...
                <div style={{ position: 'absolute', width: 18, height: 18, background: "#E5704B", color: "#fff", fontWeight: 600, fontSize: 12, boxShadow: "0px 2px 4px rgba(0, 0, 0, 0.15)", borderRadius: 12, margin: "-15px 0 0 -5px" }}>
                  <div style={{ margin: "0 4.6px", cursor: "pointer" }}>4</div>
                </div>
              </div>
        ...
        <Heading>
          <FlexAlign style={{ height: "inherit" }} as={FlexJustifyContent} justifyContent="space-between">
            ...
            <Flex style={{ height: 18, userSelect: "none" }}>
              <Flex style={{ cursor: "pointer" }}>
                <div>
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
              ...
              <Flex
                lex style={{ margin: "0 24px", cursor: "pointer" }}>
                <div>
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
        ...
        <Main as={Flex}>
          <Aside>
            ...
            <div>
              ...
              <div>
                ...
                <div style={{ cursor: "pointer", margin: "12px 0" }} >
                  {/* <input type="checkbox" id="checkStar1" style={{ cursor: "pointer" }} /> */}
                  <Flex as="label" style={{ cursor: "pointer", fontSize: 14 }}>
                    <Checkbox
                      checked={checkedStar}
          ...
          <MainContainer style={{ width: 870, margin: "0 32px" }}>
            {
              dataPostagens.map(({ id, label, price, beforePrice, img, star }) => (
                ...
                <Flex key={id} style={{ margin: "0 0 32px", border: "1px solid #D1D1D1", borderRadius: 12 }}>
                  ...
                  <div style={{ margin: 32, width: 269, height: 212 }}>
                      ...
                      <Flex>

                        {
                          ...
                          star.map(({ state }) => {
                            ...
                            if (state === 1) {
                              return (<div key={Math.floor(Math.random() * 100) - 0} style={{ margin: "0 2px 0 0" }}>
                              ...
                              return (<div style={{ margin: "0 2px 0 0" }}>
                    ...
                    <div style={{ width: 237, fontSize: "14px", color: "#A9A9A9" }}>
                      <FlexJustifyContent justifyContent="space-between" style={{ margin: "0 0 8px 0" }}>
                        <div>
                          <span>Frescura</span>
                        </div>
                        <div>
                          <span><span style={{ color: '#6A983C' }}>Novo</span> (extra fresco)</span>
                        </div>
                      </FlexJustifyContent>
                      <FlexJustifyContent justifyContent="space-between" style={{ margin: "0 0 8px 0" }}>
                        <div>
                      ...
                      <FlexJustifyContent justifyContent="space-between">
                        <div>
                          <span>Estoque</span>
                        </div>
                        <div>
                          <span><span style={{ color: '#6A983C' }}>320 pcs</span></span>
                        </div>
                      </FlexJustifyContent>
                    </div>
                  ...
                  <div style={{ margin: "32px 32px 0 32px" }}>
                    ...
                    <div>
                      ...
                      <div>
                        <FlexJustifyContent as={FlexAlign} style={{ height: 36, width: 164, background: "#F5F5F5", borderRadius: 12, userSelect: "none", cursor: "pointer" }}>

                          <Flex style={{ marginRight: 8 }}>
                            <svg width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M2 2H4.37403L6.51744 11.2994H15.1047L16 4.67926H5.5814" stroke="#151515" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                              <path d="M8.05727 12.751H8.05048C7.56349 12.751 7.1687 13.1458 7.1687 13.6328V13.6395C7.1687 14.1265 7.56349 14.5213 8.05048 14.5213H8.05727C8.54426 14.5213 8.93905 14.1265 8.93905 13.6395V13.6328C8.93905 13.1458 8.54426 12.751 8.05727 12.751Z" stroke="#151515" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" />
                              <path d="M8.05727 12.751H8.05048C7.56349 12.751 7.1687 13.1458 7.1687 13.6328V13.6395C7.1687 14.1265 7.56349 14.5213 8.05048 14.5213H8.05727C8.54426 14.5213 8.93905 14.1265 8.93905 13.6395V13.6328C8.93905 13.1458 8.54426 12.751 8.05727 12.751Z" stroke="#151515" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" />
                              <path d="M12.7103 12.751H12.7036C12.2166 12.751 11.8218 13.1458 11.8218 13.6328V13.6395C11.8218 14.1265 12.2166 14.5213 12.7036 14.5213H12.7103C13.1973 14.5213 13.5921 14.1265 13.5921 13.6395V13.6328C13.5921 13.1458 13.1973 12.751 12.7103 12.751Z" stroke="#151515" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                          </Flex>
          ...
          <FlexJustifyContent as={FlexAlign} justifyContent="space-between">
            <Flex>
              ...
              <div>
                <NavUl as={Flex}>
                  {
                    [1, 2, 3, 4].map(_ => <Flex><li style={{ padding: 0, margin: 0, fontSize: 12, color: "#151515", marginLeft: 8, cursor: 'pointer' }}>{_}</li></Flex>)
                  }
                </NavUl>
              </div>
            </Flex>
                ...
                <NavUl>
                  {
                    ["About Us", "Careers", "Press Releases", "Blog"].map(_ => (
                      <div key={_} style={{ margin: "8px 0", fontSize: 14, color: "#6A983C", cursor: "pointer" }}>
                        <li>
                          <span>{_}</span>
                        </li>
                      </div>
        ...
        <Tags as={Navigations} style={{ marginTop: 48 }}>
          <div>
            <div style={{ fontSize: 18, fontWeight: 600, margin: "0 0 16px 0" }}>
            ...
            <Flex style={{ flexWrap: "wrap" }} >
              {
                [
                  ...
                  <div style={{ width: "auto", height: 26, borderRadius: 18, color: "#151515", background: "#F5F5F5", padding: "4px 16px", margin: "0px 8px 16px 0", fontWeight: 600, fontSize: 12, lineHeight: 2.1 }}>
                    <span>{_}</span>
                  </div>
                ))
              }
